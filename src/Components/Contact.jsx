  ...
  return (
    <div className="min-h-screen bg-slate-200 dark:bg-black text-black dark:text-white text-center" id='Contact'>
      ...
      className="w-full py-4 flex items-center justify-center gap-4 flex-wrap mt-10 lg:mt-14">
        ...
        <svg className="relative z-10 fill-gray-900 transition-all duration-300 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
          <path
        ...
        <svg className="fill-gray-900 relative z-10 transition-all duration-500 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 51 51" fill="none">
        <path
        ...
        <svg className="fill-black z-10 transition-all duration-300 group-hover:fill-black dark:group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
        <path
        ...
        <svg className="fill-gray-900 relative z-10 transition-all duration group-hover:fill-black-dark:300 group-hover:fill-white"  xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
        ...
        <svg className="fill-gray-900 relative z-10 group-hover:fill-black dark:group-hover:fill-white transition-all duration-300 " 
